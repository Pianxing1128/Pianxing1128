...
//        //SimpleGrantedAuthority::getAuthority 调用SimpleGrantedAuthority 类的getAuthority方法
//        // collect 收集
...
//        stringRedisTemplate.opsForValue().set("logintoken:"+jwtToken,objectMapper.writeValueAsString(authentication),999950000, TimeUnit.HOURS);

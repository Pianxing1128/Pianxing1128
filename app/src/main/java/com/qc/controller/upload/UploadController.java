...
//        String ext = "." + FilenameUtils.getExtension(orgFileName); --需要导依赖
        ...
        log.info("applicationHome.getDir():"+applicationHome.getDir());
        log.info(" applicationHome.getDir().getParentFile():"+ applicationHome.getDir().getParentFile());
        log.info("applicationHome.getDir().getParentFile().getParentFile():"+applicationHome.getDir().getParentFile().getParentFile());
        log.info("applicationHome.getDir().getParentFile().getParentFile().getAbsolutePath():"+applicationHome.getDir().getParentFile().getParentFile().getAbsolutePath());
